...
int correct_num(const string& ori, const string& user)
//this function compare ori digit generated by computer with the user defined digit
// it return the number of correct numbers enter by the user irrespective of their position
{
	...
	for (int i = 0; i < INPUT_NUM; ++i) {
		...
		for (int j = 0; j < INPUT_NUM; ++j) {
			...
			if (ch_ori == ch_user){
				++count;
				break;//this is to ensure that only one cow is detected per original data
				}
